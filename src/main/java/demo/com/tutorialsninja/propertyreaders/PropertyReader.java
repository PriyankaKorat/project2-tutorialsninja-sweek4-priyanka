package demo.com.tutorialsninja.propertyreaders;
...
public class PropertyReader {
    ...
    public String getProperty(String propertyName) {
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir") + "/src/test/java/resourses/propertiesfile/config.properties");
